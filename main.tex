    ...
    \resumeSubheading
      ...
      {Software Engineer - Trust and Fraud}{Jan 2023 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Increased the capacity of bulk-logout-users action from 100 to 50000 each job, by utilising Kafka as a buffering mechanism}
        \resumeItemListEnd
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Languages:}{ Proficient in Go, SQL, Python, Javascipt, HTML, CSS/SCSS; familiar with Java, C, Haskell, Dart, MIPS} \\ \vspace{3pt}
